...
- Full TUI that's fully navigable by keyboard
...
| [dacap/clip](https://github.com/dacap/clip) | Copy to clipboard |

**nlohmann/json** and **dacap/clip** are fetched automatically by CMake, though **FTXUI** must be installed within`dependencies/FTXUI/` and **libsodium** must be installed on the system.
